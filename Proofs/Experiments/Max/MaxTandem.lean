...
scoped notation "merge_end" => 0x0cc5bc#64
...
@[simp] def entry_start_inv : Prop := si = s0
@[simp] def entry_end_inv : Prop := True
...
@[simp] def merge_end_inv : Prop := True
