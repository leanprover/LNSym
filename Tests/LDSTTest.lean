...
/--
info: { gpr := (0x00#5 : 0x0000000000000000#64) 
         (0x01#5 : 0x0000000000000000#64) 
         (0x02#5 : 0x0000000000000000#64) 
         (0x03#5 : 0x0000000000000000#64) 
         (0x04#5 : 0x0000000000000000#64) 
         (0x05#5 : 0x0000000000000000#64) 
         ...,
  sfp := (0x00#5 : 0x00000000000000000000000000001234#128) 
         (0x01#5 : 0x00000000000000000000000000000000#128) 
         (0x02#5 : 0x0000000000000000000000000000abcd#128) 
         (0x03#5 : 0x00000000000000000000000000000000#128) 
         (0x04#5 : 0x00000000000000000000000000000000#128) 
         (0x05#5 : 0x00000000000000000000000000000000#128) 
         ...,
  pc := 0x0000000000000000#64,
  pstate := { n := 0x0#1, z := 0x0#1, c := 0x0#1, v := 0x0#1 },
  mem := (0x0000000000000000#64 : 0x00#8) 
         (0x0000000000000001#64 : 0x00#8) 
         (0x0000000000000002#64 : 0x00#8) 
         (0x0000000000000003#64 : 0x00#8) 
         (0x0000000000000004#64 : 0x00#8) 
         (0x0000000000000005#64 : 0x00#8) 
         ...,
  program := [(0x0000000000000000#64, 0xad008820#32)],
  error := StateError.None }
-/
#guard_msgs in
...
/--
info: 0x0000000000000000000000000000abcd00000000000000000000000000001234#256
-/
#guard_msgs in
