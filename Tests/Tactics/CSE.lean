...
[Tactic.cse.generalize] ✅️ succeeded in generalizing hx1. (x y z x1 : Nat
    hx1 : y + y + (y + y) = x1
    ⊢ x + x + x1 = x1 + x1 + x1)
[Tactic.cse.generalize] ⌛ Generalizing hx2 : y + y = x2
[Tactic.cse.generalize] ✅️ succeeded in generalizing hx2. (x y z x1 x2 : Nat
    hx2 : y + y = x2
    hx1 : x2 + x2 = x1
    ⊢ x + x + x1 = x1 + x1 + x1)
...
[Tactic.cse.generalize] ✅️ succeeded in generalizing hx1. (y x1 : Nat
    hx1 : y + y = x1
    x : BitVec x1
...
x36 : BitVec (63 - 0 + 1)
hx36 : BitVec.extractLsb 63 0 d = x36
hx15 : x17 + x36 = x15
x37 : BitVec (127 - 64 + 1)
hx37 : BitVec.extractLsb 127 64 b = x37
hx31 : x37.rotateRight 18 = x31
...
hx28 : x36 + x38 = x28
x39 : BitVec (63 - 0 + 1)
hx39 : BitVec.extractLsb 63 0 c = x39
hx9 : x39 + x13 = x9
x40 : BitVec (127 - 64 + 1)
hx40 : BitVec.extractLsb 127 64 c = x40
hx10 : x40 + x12 = x10
hx19 : x40 + x22 = x19
x41 : BitVec (127 - 64 + 1)
...
hx30 : x41 + x35 = x30
x42 : BitVec (63 - 0 + 1)
hx42 : BitVec.extractLsb 63 0 a = x42
hx29 : x37 &&& x42 = x29
x43 : BitVec (127 - 64 + 1)
...
hx5 : x44 + x11 = x5
⊢ x2 ++
      ((x1 &&& x37 ^^^ ~~~x1 &&& x42) + (x1.rotateRight 14 ^^^ x1.rotateRight 18 ^^^ x1.rotateRight 41) +
        BitVec.extractLsb 63 0 x4) =
    x11 ++
      (x39 + (x5.rotateRight 14 ^^^ x5.rotateRight 18 ^^^ x5.rotateRight 41) + (x5 &&& x37 ^^^ ~~~x5 &&& x42) + x41 +
        x35)
-/
