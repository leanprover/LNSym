...
theorem mem_subset_refl : mem_subset a1 a2 a1 a2 := by
  simp [mem_subset]
  bv_check "SeparateProofs.lean-mem_subset_refl-78-2.lrat"

theorem mem_subsets_overlap (h : mem_subset a1 a2 b1 b2) :
  mem_overlap a1 a2 b1 b2 := by
  revert h
  simp [mem_subset, mem_overlap]
  bv_check "SeparateProofs.lean-mem_subsets_overlap-84-2.lrat"

theorem mem_subset_eq : mem_subset a a b b = (a = b)  := by
  simp [mem_subset]
  bv_check "SeparateProofs.lean-mem_subset_eq-88-2.lrat"

theorem mem_subset_first_address (h : mem_subset a b c d) :
  mem_subset a a c d := by
  revert h
  simp_all [mem_subset]
  bv_check "SeparateProofs.lean-mem_subset_first_address-94-2.lrat"
...
theorem mem_subset_one_addr_neq (h1 : a ≠ b1)
  ...
  revert h
  simp_all [mem_subset]
  bv_check "SeparateProofs.lean-mem_subset_one_addr_neq-101-2.lrat"
...
theorem mem_subset_same_address_different_sizes
  ...
  revert h
  simp [mem_subset]
  bv_check "SeparateProofs.lean-mem_subset_same_address_different_sizes-108-2.lrat"

theorem first_address_is_subset_of_region :
  mem_subset a a a (a + n) := by
  simp [mem_subset]
  bv_check "SeparateProofs.lean-first_address_is_subset_of_region-113-2.lrat"
...
private theorem first_address_add_one_is_subset_of_region_helper (n addr : BitVec 64)
  ...
  bv_check
    "SeparateProofs.lean-_private.Arm.Memory.SeparateProofs.0.first_address_add_one_is_subset_of_region_helper-119-2.lrat"
...
private theorem first_addresses_add_one_is_subset_of_region_general_helper
  ...
  addr2 + n - addr2 = 18446744073709551615#64 ∨
    ...
    bv_check
      "SeparateProofs.lean-_private.Arm.Memory.SeparateProofs.0.first_addresses_add_one_is_subset_of_region_general_helper-135-4.lrat"
...
private theorem first_addresses_add_one_preserves_subset_same_addr_helper (h1l : 0#64 < m) :
  ...
  revert h1l
  bv_check
    "SeparateProofs.lean-_private.Arm.Memory.SeparateProofs.0.first_addresses_add_one_preserves_subset_same_addr_helper-154-2.lrat"
...
private theorem mem_subset_one_addr_region_lemma_helper (n1 addr1 addr2 : BitVec 64) :
  ...
  bv_check
    "SeparateProofs.lean-_private.Arm.Memory.SeparateProofs.0.mem_subset_one_addr_region_lemma_helper-204-2.lrat"
...
theorem mem_subset_one_addr_region_lemma (addr1 addr2 : BitVec 64) (h : n1 <= 2 ^ 64) :
  ...
  intro h₀ h₁
  simp_all only [true_implies, BitVec.sub_self, _root_.and_self]
...
theorem mem_subset_trans
  ...
  revert h1 h2
  simp [mem_subset]
  bv_check "SeparateProofs.lean-mem_subset_trans-239-2.lrat"
...
theorem mem_separate_commutative :
  ...
  bv_check "SeparateProofs.lean-mem_separate_commutative-247-2.lrat"

theorem mem_separate_starting_addresses_neq :
  mem_separate a1 a2 b1 b2 → a1 ≠ b1 := by
  simp [mem_separate, mem_overlap]
  bv_check "SeparateProofs.lean-mem_separate_starting_addresses_neq-252-2.lrat"

theorem mem_separate_neq :
  a ≠ b ↔ mem_separate a a b b := by
  simp [mem_separate, mem_overlap]
  bv_check "SeparateProofs.lean-mem_separate_neq-257-2.lrat"

theorem mem_separate_first_address_separate (h : mem_separate a b c d) :
  mem_separate a a c d := by
  revert h
  simp [mem_separate, mem_overlap]
  bv_check "SeparateProofs.lean-mem_separate_first_address_separate-263-2.lrat"
...
theorem mem_separate_contiguous_regions (a k n : BitVec 64)
  ...
  revert hn
  simp [mem_separate, mem_overlap]
  bv_check "SeparateProofs.lean-mem_separate_contiguous_regions-270-2.lrat"
...
private theorem mem_separate_contiguous_regions_one_address_helper (n' addr : BitVec 64)
  ...
  bv_check
    "SeparateProofs.lean-_private.Arm.Memory.SeparateProofs.0.mem_separate_contiguous_regions_one_address_helper-276-2.lrat"
...
theorem mem_separate_for_subset2
  ...
  bv_check "SeparateProofs.lean-mem_separate_for_subset2-295-2.lrat"
